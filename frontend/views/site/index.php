        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-xs-12">
                <div class="job-featured">
                    <div class="icon">
                        <?=Html::img(Yii::getAlias('@web').'/img/features/img1.png') ?>
                    </div>
                    <div class="content">
            ...
            <div class="col-lg-4 col-md-6 col-xs-12">
                <div class="job-featured">
                    <div class="icon">
                        <?=Html::img(Yii::getAlias('@web').'/img/features/img2.png') ?>
                    </div>
                    <div class="content">
            ...
            <div class="col-lg-4 col-md-6 col-xs-12">
                <div class="job-featured">
                    <div class="icon">
                        <?=Html::img(Yii::getAlias('@web').'/img/features/img3.png') ?>
                    </div>
                    <div class="content">
            ...
            <div class="col-lg-4 col-md-6 col-xs-12">
                <div class="job-featured">
                    <div class="icon">
                        <?=Html::img(Yii::getAlias('@web').'/img/features/img4.png') ?>
                    </div>
                    <div class="content">
                        <h3><a href="job-details.html">Software Engineer</a></h3>
            ...
            <div class="col-lg-4 col-md-6 col-xs-12">
                <div class="job-featured">
                    <div class="icon">
                        <?=Html::img(Yii::getAlias('@web').'/img/features/img5.png') ?>
                    </div>
                    <div class="content">
                        <h3><a href="job-details.html">Graphic Designer</a></h3>
            ...
            <div class="col-lg-4 col-md-6 col-xs-12">
                <div class="job-featured">
                    <div class="icon">
                        <?=Html::img(Yii::getAlias('@web').'/img/features/img6.png') ?>
                    </div>
                    <div class="content">
                        <h3><a href="job-details.html">Managing Director</a></h3>
                        <p class="brand">MagNews</p>
                ...
                <div id="testimonials" class="touch-slider owl-carousel">
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="author">
                                <div class="img-thumb">
                                    <?=Html::img(Yii::getAlias('@web').'/img/testimonial/img1.png') ?>
                                </div>
                            </div>
                    ...
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="author">
                                <div class="img-thumb">
                                    <?=Html::img(Yii::getAlias('@web').'/img/testimonial/img2.png') ?>
                                </div>
                            </div>
                            <div class="content-inner">
                                <p class="description">Morbi quam enim, cursus non erat pretium veh icula finibus ex stibulum venenatis viverra dui Morbi quam enim, cursus non erat pretium veh icula finibus ex stibulum venenatis viverra dui Morbi quam enim, cursus non erat pretium veh icula finibus ex stibulum venenatis viverra dui.</p>
                    ...
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="author">
                                <div class="img-thumb">
                                    <?=Html::img(Yii::getAlias('@web').'/img/testimonial/img3.png') ?>
                                </div>
                            </div>
                            <div class="content-inner">
                                <p class="description">Morbi quam enim, cursus non erat pretium veh icula finibus ex stibulum venenatis viverra dui Morbi quam enim, cursus non erat pretium veh icula finibus ex stibulum venenatis viverra dui Morbi quam enim, cursus non erat pretium veh icula finibus ex stibulum venenatis viverra dui.</p>
        ...
        <div class="row">
                ...
                <div class="blog-item-wrapper">
                    <div class="blog-item-img">
                        <a href="single-post.html">
                            <?=Html::img(Yii::getAlias('@web').'/img/blog/img1.jpg') ?>
                        </a>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
                ...
                <div class="blog-item-wrapper">
                    <div class="blog-item-img">
                        <a href="single-post.html">
                            <?=Html::img(Yii::getAlias('@web').'/img/blog/img2.jpg') ?>
                        </a>
                    </div>
                    <div class="blog-item-text">
            ...
            <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
                ...
                <div class="blog-item-wrapper">
                    <div class="blog-item-img">
                        <a href="single-post.html">
                            <?=Html::img(Yii::getAlias('@web').'/img/blog/img3.jpg') ?>
                        </a>
                    </div>
                    <div class="blog-item-text">
